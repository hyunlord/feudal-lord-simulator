...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `scroll_frame` | 22 seed `52018411`, 23 seed `52018412`, 24 seed `52018413` | 22 | `docs/asset-evidence/before/scroll_frame.png` | `public/assets/ui/scroll_frame.png` | 512x512 | present, preserved | canonical palette plus required gold, ultramarine, and vermilion accents |
...
| `seal_slot` | 1 seed `52031470`, 2 seed `52031471`, 3 seed `52031472` | 2 | `docs/asset-evidence/before/seal_slot.png` | `public/assets/ui/seal_slot.png` | 64x64 | present, preserved | unchanged legacy RGB; dimensions and alpha preserved |
| `parchment_texture` | 1 seed `52040441`, 2 seed `52040442`, 3 seed `52040443`, 4 seed `52041444`, 5 seed `52041445`, 6 seed `52041446` | 4 | `docs/asset-evidence/before/parchment_texture.png` | `public/assets/ui/parchment_texture.png` | 512x512 | all-opaque, preserved | unchanged legacy RGB; dimensions and alpha preserved |
| `illumination_corner` | 1 seed `52050451`, 2 seed `52050452`, 3 seed `52050453`, 4 seed `52051454`, 5 seed `52051455`, 6 seed `52051456` | 5 | `docs/asset-evidence/before/illumination_corner.png` | `public/assets/ui/illumination_corner.png` | 128x128 | present, preserved | unchanged legacy RGB; dimensions and alpha preserved |
...
Active Phase 4F guided candidates:

- Candidate `scroll_frame/candidate_22_seed_52018411.png`
- Candidate `scroll_frame/candidate_23_seed_52018412.png`
- Candidate `scroll_frame/candidate_24_seed_52018413.png`
...
- `scroll_frame`: selected candidate 22 is the most balanced warm parchment
  border with four illuminated curled-corner medallions and restrained gold,
  ...
  16-21 were pale or generic. Candidates 22-24 preserve the cyan alpha masks and
  restore the guide's light, dark, gold, ultramarine, and vermilion masks after
  pixelization.
- `wood_console`: selected candidate 10 is the cleanest continuous band from the
  ...
  a raised upper edge. Candidates 11-12 amplified the material variation but
  introduced noisier bands and posts.
...
npx tsx scripts/quantisePalette.ts docs/asset-evidence/before/wood_console.png public/assets/ui/wood_console.png
...
Phase 4F final verification uses the private active-candidate root recorded in
`docs/asset-evidence/phase4f_ui_generation_manifest.json`. It proves all five
exact dimensions, alpha preservation, active candidate/manifest alignment,
canonical-palette RGB membership, hollow scroll transparency and required
accent families, plus the three-recess, grain-variation, and raised-edge wood
contracts.
