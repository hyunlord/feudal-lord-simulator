...
/** The pieces D3a draws, and the wall faces D3b draws (each group loaded on demand). */
...
export const WALL_FACE_KEYS = [...TERRAIN_VARIANTS.palisadeFace, ...TERRAIN_VARIANTS.stoneFace] as const;
