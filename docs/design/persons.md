...
- **사망(새 규칙)**: 계절 첫날(결산이 지난 계절을 닫은 다음 틱) 연령별 연 사망률 ÷ 4다.
  ...
  - 계절의 죽음은 **자랄 수 있는 집**(물·빵이 있고, 불타지도 떠날 준비 중이지도 않음)에만 온다. 그 집은 죽은 이의 자리를 곧바로 채운다(출생 또는 친척 — 성장 규칙이 한 주기 안에 채울 자리). `residents`는 그대로다. 사망은 마을의 사람을 바꾸지만 크기는 바꾸지 않는다.
  - **자랄 수 없는 집**(굶음·물 없음·떠날 준비·황폐)은 예전 감소 규칙으로 준다. 그 손실이 위의 굶어 죽음이고, 사망이 감소 규칙을 대신하는 자리다. 불에 죽은 이는 `residents`에서 빠진다.
  - 이유(가드레일 1·2회차, 결정 PS3):
    - 1회차: 죽음마다 빈자리가 생기면 "도시가 가득 찬 채 24,000틱"(안정 판정)이 끝내 이어지지 않았다. 다섯 seed 모두 960,000틱에 L4 24/24인데도 안정이 안 됐다.
    - 2회차: 자랄 수 없는 집(우물 전 초반, 굶는 집)의 죽음이 예전 감소에 더해져 승리 틱이 +20~+326 %가 됐다. 사망을 끈 진단은 seed 1 +5 % · seed 2 −14 %였다.
