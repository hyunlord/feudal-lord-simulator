...
import { AUTOPLAY_ERASE_WALLED_FIELDS_LABEL, AUTOPLAY_PAINT_ARABLE_LABEL, AUTOPLAY_REBUILD_HOUSE_LABEL, AUTOPLAY_RELOCATE_HOUSE_LABEL, AUTOPLAY_RESERVE_RECOVERY_LABEL } from './autoplayCopy.ko';
