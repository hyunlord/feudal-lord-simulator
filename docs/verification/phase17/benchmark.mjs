...
if (!['A', 'C', 'E', 'P17'].includes(task) || !['before', 'after'].includes(variant) || ![1, 2].includes(dpr) || !['paused', 'running', 'drag'].includes(condition)) throw new Error('Invalid benchmark flags');
