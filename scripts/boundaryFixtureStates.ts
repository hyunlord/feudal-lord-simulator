...
import { boundaryFixtureState } from "./boundaryFixtureScene";
...
type GroundFixture = {
  ...
  readonly buildings: readonly Building[]; readonly houses: GameState["houses"]; readonly era: GameState["era"];
};
const TERRAIN = { g: "grass", f: "forest", w: "water", r: "rock" } as const;

export function seedGroundState(seed: 1 | 2 | 3 | 4 | 5): GameState {
  const fixture = JSON.parse(gunzipSync(readFileSync(new URL(`../tests/fixtures/boundary/seed${seed}-ground.json.gz`, import.meta.url))).toString("utf8")) as GroundFixture;
  ...
  return { ...DEFAULT_GAME_STATE, seed: fixture.seed, width: fixture.width, height: fixture.height, tiles, buildings: [...fixture.buildings],
    houses: [...fixture.houses], era: fixture.era, palisade: fixture.palisade, constructionSites: [], walkers: [], roadRevision: 1, pathCache: {} };
}
