...
갱신: 2026-09-26(HIST-1 · BOT-2 · J1 판정 네 가지 · F0-C2 · UI-3 · UX-3R 1차 · F0-C1 · F0-B · INSTALL-11 · INSTALL-7 · R0 · F0-V · F0-A · INSTALL-5c · UX-2 · UX-1 · MOVE-1 · FIX-1 · BOT-1 완료 · INSTALL-4e · TOUCH-1 · PLAY-1 · V2 · C3 · C1f · C1c-2 · B9 · D3b 벽 띠 플래그 · D3b · D3a · C1e · C1d · C1c · C2 · C1b · B3 · D1a-2 · B5+C1a). 제품 본선: `codex/phase15-organic-ground`.
...
- **F0-C2 기록 원장 v0 — 관문 ①②③⑤ 통과, ④ 가드레일 4/5(seed 3 알려진 정지 FC11, 나머지 4 seed는 F0-C1과 틱까지 같음)·성능 +≤3 %, 사용자 지시(4/5면 알려진 정지로 병합)에 따라 본선 병합**(Claude Code, 엔진 세션, 렌더 0줄·봇 0줄, 검증 DGX): [기록 원장 명세](design/history-ledger.md) HL-1~HL-9, [보고서](verification/f0c2-history/REPORT.md), 결정 HL1~HL8.
  ...
  - 연대기 한 쪽(FC-5)을 원장에서 생성(`recordId`). 렌더 API `history.query/snapshot/summary/date`(UI-4·CHRON-1).
  - seed 2 1장 원장 2,806건·저장 +765 KB·왕복 동일. 원장은 시뮬레이션을 바꾸지 않는다(원장을 뺀 세계 해시 고정값 F0-C1 그대로). DGX 전체 회귀·깨끗한 클론 `9eb0707` 3,023/3,023.
...
- **UI-3 압력이 화면에 — 계절 결산·계절 띠·배치 장부·집 압력·보릿고개·타이틀(Wave 8): 관문 ①~⑦ 통과, ⑧ 사용자 판정 대기, 본선 병합**(Claude Code, 렌더·UI·스타일·에셋·대장·스크립트·테스트·문서만, 엔진 0줄, 검증 DGX): [UI-3 명세](design/season-ledger-ui.md) UI3-1~UI3-7, [보고서](verification/ui3/REPORT.md), 결정 UI3-D1~D8.
  ...
  - 떠날 채비 집에 식량 원인 그림 + inspector 첫 줄, 보릿고개 목표 카드(가장 급함) + 청지기 걱정, 일시정지 비네트, 타이틀 키아트·엠블럼·모드 배경·0.9초 장 화면, 위기 = 알림 종.
  - UX-3 바로잡음: 청지기 말풍선이 화면 밖이었다 → 버튼 위 한 줄 8초, 누르면 전체. UX-3 관문 재실행 통과(면적 18/18, 튜토리얼 22 = 22, B9·터치 13/13). 성능 본선과 같음, 클론 `dca8c3a` 3,006/3,006.
  - 등록만: 1315·1337·1348 장 화면, 겹쳐보기 아이콘 8, 미니맵·목표 서랍·연대기·청원 틀과 장식(자리가 생기면 붙인다 — F0-C1 청원·연대기 화면 작업).
...
- **F0-C1 흐름 뼈대 3 — 대기근·첫 청원·연대기·1장 끝: 관문 ①~⑤ 통과, 가드레일 4/5(3회차, seed 3 알려진 정지 FC11), 사용자 지시로 본선 병합**(Claude Code, 엔진 세션, 렌더 0줄, 검증 DGX): [1장 명세](design/flow-chapter-one.md) FC-1~FC-7, [보고서](verification/f0c1-famine/REPORT.md), 결정 FC1~FC11.
  ...
  - 관문 ② 1장 완주 5/5(대기근 진입 1316·1317·1318·1320강제 ×2, 장 끝 1320~1323), ③ 구휼이 이탈 0 대 방관 72, 금고 5/5 적음.
  - 봇 복구: 구휼 예산 = 지난 계절 수입(FC3), 석재 창고 복구 확장(FC8), 통나무 넘침이면 제재소 먼저(AR-10, FC9). 창고 "받는 품목 토글"은 아직 없음(FC10 메모).
