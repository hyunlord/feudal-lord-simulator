...
| 항목 | 상태 |
|---|---|
| Wave 16 | `output/astra-wave16-candidates-v1/`가 11시 현재 만들어지는 중(ZIP 없음). ZIP이 오면 받는다. 작업 폴더 스냅숏은 `astra-raw/output/`에 있음 |
