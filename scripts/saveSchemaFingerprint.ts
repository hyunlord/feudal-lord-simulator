// Computes the save-schema fingerprint and, with --write, updates src/save/schemaFingerprint.v1.json.
...
export const FINGERPRINT_PATH = resolve(ROOT, "src/save/schemaFingerprint.v1.json");
