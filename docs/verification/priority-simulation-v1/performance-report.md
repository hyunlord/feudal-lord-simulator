...
Scripts/results: `performance-browser.mjs/.json`, `performance-parity.mjs/.json`, `performance-tests.log`. Individual screenshots: [baseline](performance-baseline.png), [cached](performance-cached.png).
